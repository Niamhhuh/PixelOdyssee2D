...
public class DancePad : ObjectScript
{
    ...
    private void InitiateDance()
    {
        ...
        PadController.transform.position = new Vector3(PadController.transform.position.x, PadController.transform.position.y + +2f, PadController.transform.position.z);
