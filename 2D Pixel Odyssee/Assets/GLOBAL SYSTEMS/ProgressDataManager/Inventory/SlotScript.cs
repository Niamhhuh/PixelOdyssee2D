...
public class SlotScript : MonoBehaviour, IDropHandler
{
    ...
    public void OnDrop(PointerEventData eventData)
    {
        ...
        {
            eventData.pointerDrag.GetComponent<Acquired>().Slot = SlotID;                                   //Pass current SlotNumber to AcquiredItem
            eventData.pointerDrag.GetComponent<Acquired>().CurrentSlot = this;                              //Pass current SlotScript to AcquiredItem
        }
    }
